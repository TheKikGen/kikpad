...
void USBMidi::begin() {
    ...
    usb_midi_enable(PIN_MAP[HAS_DISC_ON_PIN].gpio_device, PIN_MAP[HAS_DISC_ON_PIN].gpio_bit,1);
#else
...
#ifdef HAS_DISC_ON_PIN
    usb_midi_disable(PIN_MAP[HAS_DISC_ON_PIN].gpio_device, PIN_MAP[HAS_DISC_ON_PIN].gpio_bit,0);
#else
